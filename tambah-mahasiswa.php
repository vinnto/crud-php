                ...
                <div class="col-12 mb-5">
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama mahasiswa..." required autocomplete="off">
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                ...
                                <select name="prodi" id="prodi" class="form-control" required>
                                    ...
                                    <option value="Teknik Mesin">Sistem Informasi</option>
                                    <option value="Teknik Listrik">Teknik Elektronika</option>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="telepon" name="telepon" placeholder="Telepon..." required autocomplete="off">
                        </div>
                        ...
                        <button type="button" onclick="location.href='mahasiswa.php'" class="btn btn-danger btn-sm"><i class="fas fa-backward"></i> Back</button>
                    </form>
                </div>
            </div>
        </div>
