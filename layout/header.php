    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index.php" class="brand-link">
                <img src="assets-template/dist/img/uinbsk.png" alt="uinbsk" class="brand-image img-circle elevation-3">
                <span class="brand-text font-weight-light">Sisfo Penjualan</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="assets-template/dist/img/cekrek.jpg" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
