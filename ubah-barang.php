    ...
    <section class="content">
        <div class="container-fluid">
            <form action="" method="post">
                ...
                <button type="submit" name="ubah" class="btn btn-primary btn-sm" style="float: right;">Update</button>
                <button type="button" onclick="location.href='index.php'" class="btn btn-danger btn-sm"><i class="fas fa-backward"></i> Back</button>
            </form>
        </div>
    </section>
    <!-- /.content -->
